...
|--------|-----|-----|-----|------|-----------|---------------|
| BiEncoder (baseline, 2-tower) | 0.4033 | 0.256 | 0.585 | 0.715 | 0.9688 | 0.6967 |
| CDE v1 (KL, shared enc) | 0.4062 | 0.254 | 0.575 | 0.703 | 0.8078 | — |
| CDEv2 stage-1 only (retriever) | 0.4094 | 0.260 | 0.596 | 0.724 | 0.9634 | 0.7287 |
| **CDEv2 + CE-rerank (full system)** | **0.4555** | **0.310** | **0.632** | **0.754** | **0.9829** | **0.8341** |
| **Lift over baseline** | **+12.9%** | **+21%** | **+8%** | **+5.5%** | **+1.5%** | **+19.7%** |
