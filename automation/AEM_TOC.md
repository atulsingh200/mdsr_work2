...
+ AEM as a Cloud Service Migration Journey {#migration-journey}
  ...
  + Cloud Transition Tools {#cloud-migration}
    ...
    + Content Transfer Tool {#content-transfer-tool}
      ...
      + [Bulk Upload of Principals to IMS after Migration](/help/journey-migration/content-transfer-tool/using-content-transfer-tool/bulk-principal-uploading.md)
...
+ Forms {#forms}
  ...
  + HTML5 Forms {#html5-forms}
    + [Introduction to HTML5 forms](/help/forms/introductionhtml5.md)
    + [Getting started with HTML5 forms](/help/forms/get-started.md)
    + [Architecture of HTML5 forms](/help/forms/html5-forms-architecture.md)
    + [Feature differentiation between HTML5 forms and PDF forms](/help/forms/feature-differentiation-html5-forms-pdf-forms.md)
    + [Frequently asked questions (FAQ) for HTML5 forms](/help/forms/faqhtml5.md)
    + [Designing form templates for HTML5 forms](/help/forms/designing-form-template.md)
    + [Best practices for HTML5 forms](/help/forms/best-practices-for-html5-forms.md)
    + [Designing accessible HTML5 forms](/help/forms/design-accessible-html5-forms.md)
    + [Generate HTML5 preview of an XDP form](/help/forms/preview-xdp-forms-html.md)
    + [Rendering form template for HTML5 forms](/help/forms/rendering-form-template.md)
    + [Enabling attachments for an HTML5 form](/help/forms/enabling-attachments-html5-form.md)
    + [HTML5 forms service proxy](/help/forms/service-proxy.md)
    + [Optimizing HTML5 forms](/help/forms/optimize-html5-forms.md)
    + [Screen readers for HTML5 forms](/help/forms/screen-readers.md)
    + [Creating a custom profile for HTML5 forms](/help/forms/custom-profile.md)
    + [Right-to-left languages in HTML5 forms](/help/forms/right-left-languages.md)
    + [Integrating Form Bridge with custom portal for HTML5 forms](/help/forms/integrate-form-bridge-forms-portal.md)
    + [Create custom appearances in HTML5 forms](/help/forms/custom-widgets.md)
    + [Changing default styles of HTML5 forms](/help/forms/changing-default-styles.md)
    + [Picture clause support for HTML5 forms](/help/forms/picture-clause-support.md)
    + [Create accessible complex tables in HTML5 forms](/help/forms/accessible-tables.md)
    + [Creating CSS styles for HTML5 forms](/help/forms/css-styles.md)
    + [Customizing error messages for HTML5 forms](/help/forms/customzing-errors-html5-forms.md)
    + [Saving an HTML5 form as a draft](/help/forms/saving-html5-form-draft.md)
    + [Enable logging for HTML5 forms](/help/forms/enable-logs.md)
...
+ Edge Delivery Services {#edge-delivery}
  ...
  + Building Forms {#build-forms}
    ...
    + Document-based authoring {#getting-started-edge-delivery-services-forms}
      ...
      + [Build Reusable Forms: Guide to Form Fragments](/help/edge/docs/forms/form-fragments.md)
      + [Create Dynamic Forms: Adding Repeatable Sections](/help/edge/docs/forms/repeatable-forms.md)
