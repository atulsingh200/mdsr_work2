#!/usr/bin/env python3
"""Generate LLM reasoning for aep_gapdecay_notier11 directional pairs.

Uses the AEP architecture-ordering prompt.
Rows are written to disk immediately as they complete.
Supports --resume to skip already-done rows.

Usage:
    python3 scripts/generate_reasoning_aep_gapdecay.py \
        --data-dir data/aep_gapdecay_notier11 \
        --out-dir  data/aep_gapdecay_notier11_with_reasoning \
...
# ---------------------------------------------------------------------------
# Prompts (AEP architecture ordering)
# ---------------------------------------------------------------------------
SYSTEM_PROMPT = """\
...
Experience Platform? Be brief, then end with exactly one VERDICT line.\
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Generate claude-sonnet-4-6 reasoning for aep_gapdecay pairs.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    ap.add_argument("--data-dir",    default="data/aep_gapdecay_notier11")
