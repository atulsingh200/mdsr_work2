...
through OUR cross-encoder trained on merged_gapdecay_procedural so the two
architectures can be compared on identical inputs.

Model  : CrossEncoder2x  (microsoft/deberta-v3-large backbone)
Run    : crossencoder2x_deberta / merged_gapdecay_procedural
...
# ── save ───────────────────────────────────────────────────────────────────────
out_path = _HERE / "audience_email_results_gapdecay.json"
