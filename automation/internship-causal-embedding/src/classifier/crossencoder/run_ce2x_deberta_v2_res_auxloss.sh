...
# trained on aep_ajo_procedural_workflow_v2_res (original reasoning, labels aligned).
# Loss = L_BCE + 0.7 * L_LM
...
mkdir -p "$RUNS"
RUN_NAME=v2_res_lm_alpha07

echo "===== CE2x-DeBERTa + reasoning aux-loss (alpha=0.7) on aep_ajo_procedural_workflow_v2_res ====="
