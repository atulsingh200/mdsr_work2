"""Train CrossEncoder2xWithReasoning: CE2x classifier + auxiliary reasoning decoder.
...
sys.path.insert(0, str(_CE2X_MODEL_DIR))
sys.path.insert(0, str(_REPO_ROOT))

if __package__ in (None, ""):
    from src.classifier.crossencoder.data import CEReasoningCollate, CEPairReasoningDataset, _parse_step, strip_verdict
    ...
    from .data import CEReasoningCollate, CEPairReasoningDataset, _parse_step, strip_verdict
