...
|---|---|---|---:|---:|---:|---:|---:|---:|
| MiniLM-L6-v2 | none | random (4)        | 0.9371 | 0.8435 | 0.9795 | 0.7238 | 0.8520 | 0.8994 |
...
| MiniLM-L6-v2 | none | full-corpus (N−1) | 0.9470 | 0.8881 | 0.9805 | 0.7179 | 0.8677 | 0.9054 |
| BERT-base    | none | random (4)        | 0.7294 | 0.6128 | 0.6350 | 0.5821 | 0.5400 | 0.7817 |
...
| BERT-base    | none | full-corpus (N−1) | 0.7699 | 0.6543 | 0.7166 | 0.6041 | 0.6886 | 0.8217 |
...
| Model | Fine-tune | Eval negatives | aep_causal | aep_followup | followupqg | multiwoz_v24 | qrecc | workflow |
|---|---|---|---:|---:|---:|---:|---:|---:|
| MiniLM-L6-v2 | none | random (4)        | 0.8754 | 0.7498 | 0.9441 | 0.4765 | 0.7100 | 0.8046 |
...
| MiniLM-L6-v2 | none | full-corpus (N−1) | 0.1566 | 0.0542 | 0.4331 | 0.0117 | 0.0265 | 0.0042 |
| BERT-base    | none | random (4)        | 0.5338 | 0.4143 | 0.4611 | 0.3149 | 0.4450 | 0.6273 |
...
| BERT-base    | none | full-corpus (N−1) | 0.0285 | 0.0072 | 0.0419 | 0.0011 | 0.0069 | 0.0026 |
...
| multiwoz_v24  |   7,368 | 0.7238 | 0.4765 |
...
| multiwoz_v24  |   7,368 | 0.5821 | 0.3149 |
...
| multiwoz_v24  |   7,368 | 0.7179 | 0.0117 |
| qrecc         |   5,204 | 0.8677 | 0.0265 |
...
| multiwoz_v24  |   7,368 | 0.6041 | 0.0011 |
| qrecc         |   5,204 | 0.6886 | 0.0069 |
...
| multiwoz_v24  | 0.5821 | **0.9526** | +0.371 | 0.3149 | **0.8694** | +0.555 |
| qrecc         | 0.5400 | **0.9227** | +0.383 | 0.4450 | **0.8113** | +0.366 |
| workflow      | 0.7817 | **0.9662** | +0.185 | 0.6273 | **0.9104** | +0.283 |

Biggest AUC lift on `qrecc` (+0.38) and `multiwoz_v24` (+0.37); biggest P@1 lift on `multiwoz_v24` (+0.56) — both datasets where raw BERT was near chance. Smallest on `workflow` (+0.19 / +0.28) where raw BERT was already strong.
...
- **Fine-tuned BERT beats every inference baseline** on every shared dataset on both AUC and P@1 (random eval). Biggest gaps on `multiwoz_v24` and `qrecc`.
