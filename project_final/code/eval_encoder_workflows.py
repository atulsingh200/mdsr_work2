#!/usr/bin/env python3
"""
Evaluate baseline vs reasoning model on the 697-workflow eval set.
...
Dataset:
  /mnt/localssd/causal-embedding-research/final_data/aep_workflows_eval.json
...
DATA_PATH = Path("/mnt/localssd/causal-embedding-research/final_data/aep_workflows_eval.json")
...
# ── Final table ───────────────────────────────────────────────────────────────
print(SEP)
print("FINAL RESULTS — aep_workflows_eval.json (697 wf)")
print(SEP)
